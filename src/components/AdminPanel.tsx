...
type AdminPanelView = 'scanner' | 'usage';
...
const AdminPanel: React.FC = () => {
    ...
    const handleScan = async () => {
        ...
        try {
            ...
            const textPart = { text: `Analyze the attached image of a musician's union contract document. Extract all relevant information to create a complete JSON configuration for a single 'ContractType' object that can be used in our system.
            ...
            <header className="bg-gray-800 shadow-md">
                <div className="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8 flex justify-between items-center">
                    <div>
                        ...
                        <p className="text-sm text-gray-400">Manage contract configurations and monitor usage.</p>
                    </div>
                     ...
                     <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
                            ...
                            <button
                                ...
                                className="mt-6 w-full bg-green-600 text-white font-bold py-2 px-4 rounded-md hover:bg-green-700 disabled:bg-gray-500 disabled:cursor-not-allowed flex items-center justify-center"
                            >
                                {isLoading ? (
                                    <>
                        ...
                        <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
                            <div className="flex justify-between items-center mb-4">
                                <h2 className="text-xl font-bold">3. Generated JSON Output</h2>
                                {generatedJson && (
                                    <button
                                        onClick={copyToClipboard}
                                        className="bg-gray-600 hover:bg-gray-500 text-white text-xs font-bold py-1 px-2 rounded"
                                    >
                                        Copy
                                    </button>
                                )}
                            ...
                            <div className="relative mt-4">
                                <pre className="bg-gray-900 rounded-md p-4 text-xs text-green-300 overflow-x-auto h-96">
                                    <code>
